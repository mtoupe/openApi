...
# 介绍
欢迎使用[topex]开发者文档。
本文档提供了topex交易平台的币币交易(Spot)业务的行情查询、交易、账户管理等API使用方法的介绍。
...
# API接口加密验证
## 生成API KEY
在对任何请求进行签名之前，您必须通过 topex网站【用户中心】-【API】创建一个API KEY。 创建API KEY后，您将获得3个必须记住的信息：
* API Key
* Secret Key
* Passphrase
...
```
## 请求交互  
REST访问的根URL：`https://www.topex.vip`
### 请求
